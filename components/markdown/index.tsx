...
export default function Markdown({ md, deleteId, className, asCard, hasWrapped, disableSave, onlyComments }: MarkdownProps) {
    ...
    return (<MarkdownToJSX
        ...
        className={cn('dark:prose-invert prose prose-blockquote:not-italic prose-blockquote:border-danger prose-blockquote:border-l-1.5 before:prose-code:content-["["] after:prose-code:content-["]"]', className)}
