...
import { FYP_GITHUB_LINK } from '@/lib/config'
                    ...
                    <>
                        ...
                        <ModalBody className='prose prose-sm dark:prose-invert font-formal'>
                            <div className='space-y-4'>
                                ...
                                <p>由于本服务开源，你可以在 <Link href={FYP_GITHUB_LINK} target='_blank' className='underline underline-offset-2'>GitHub</Link> 上<strong>检视源代码</strong>。</p>
                            </div>
                        </ModalBody>
                        <ModalFooter>
