                    ...
                    <>
                        ...
                        <ModalBody style={{ fontFamily: postFontFamily }} className='prose prose-sm dark:prose-invert'>
                            <div className='space-y-4'>
                                <p>你上传的文件将会被发送给 Google，但不会被 <span className='italic'>Fix. Your. Paper.</span> 存储。也就是说，我们无法看到你上传的试卷内容。</p>
                                <p className='font-bold'>但你没有必要相信我们——</p>
                                <p>由于本服务开源，你可以在 <Link href='https://github.com/NarixHine/leximory/tree/main/app/fix-your-paper' target='_blank' className='underline underline-offset-2'>GitHub</Link> 上自己检视源代码。</p>
                            </div>
                        </ModalBody>
                        <ModalFooter>
