...
export default function MemoriesPage() {
    return (
        <Main className='max-w-screen-lg mx-auto flex flex-col bg-[radial-gradient(#e7e5e4_1px,transparent_1px)] dark:bg-[radial-gradient(#292524_1px,transparent_1px)] [background-size:20px_20px]'>
