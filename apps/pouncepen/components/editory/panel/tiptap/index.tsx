        ...
        <div className='w-full'>
            ...
            >
                <IconContext.Provider
                    value={{ className: 'text-primary', size: 16, weight: 'duotone' }}
                >
                    <div className='flex items-center gap-1'>
                        <ButtonGroup className='bg-background/50 backdrop-blur-md z-10 shadow-medium dark:border-primary-50 rounded-xl overflow-clip'>
                            ...
                            <Button
                                ...
                                variant={
                                    editor.isActive('heading', { level: 3 }) ? 'shadow' : 'light'
                                }
                                isIconOnly
                        ...
                        <Dropdown>
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownItem
                                    key='strikethrough'
                                    startContent={<TextStrikethroughIcon />}
