...
export default function SummaryEditor({
    ...
    return (
        <div className='flex flex-col gap-2 before:content-["Summary"] before:text-secondary-300 before:font-bold before:-mb-2 my-5'>
                ...
                {data.essentialItems.map((item, index) => (
                    <div key={`essential-${index}`} className='flex items-center gap-2'>
                        ...
                        <Button
                            ...
                            variant='light'
                            color='danger'
                            onPress={() => removeEssentialItem(index)}
                        >
                            <TrashIcon size={14} />
                        </Button>
                    </div>
                ...
                <div className='flex gap-2 mt-1'>
                    ...
                    <Button
                        ...
                        onPress={() => {
                            setData({
                                ...data,
                                essentialItems: [...data.essentialItems, newItem.trim()],
                            })
                            setNewItem('')
                        }}
                    >
