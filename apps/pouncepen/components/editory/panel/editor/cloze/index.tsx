...
export default function ClozeEditor({
    ...
    return (
        <div className='flex flex-col gap-2 before:content-["Cloze"] before:text-secondary-300 before:font-bold before:-mb-4 my-5'>
                            ...
                            <ModalBody>
                                {distractors.map((distractor, index) => (
                                    <Input
                                        ...
                                        onValueChange={value => {
                                            setDistractors(
                                                toFilled(distractors, value, index, index + 1),
                                            )
                                        }}
                                        variant='underlined'
                                    />
                            ...
                            <ModalFooter>
                                ...
                                <Button
                                    ...
                                    onPress={() => {
                                        ...
                                        newData.questions = questions.filter(q =>
                                            blanks.includes(q.original),
                                        )
            ...
            <Tiptap
                ...
                blank={word => {
                    setBlankedWord(word)
                    setDistractors(
                        data.questions.find(q => q.original === word)?.distractors ?? ['', '', ''],
                    )
                    onOpen()
                }}
                unblank={word => {
