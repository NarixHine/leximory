    ...
    return (
        <Card shadow='none' className='border border-default p-3 hover:border-default-300 transition-all duration-200 ease-in-out' isPressable as={Link} href={`/paper/${id}`}>
            <CardHeader className='flex flex-col items-start'>
                <Skeleton isLoaded={isSuccess} className='h-5 rounded-2xl mb-2'>
...
export function PaperCardSkeleton() {
    return (
        <Card shadow='none' className='border border-default p-3'>
            <CardHeader className='flex flex-col items-start'>
                <Skeleton className='h-5 mb-3 rounded-2xl'>
                ...
                <Skeleton className='h-9 mb-2 rounded-lg'>
                    <h3 className='text-3xl italic'>Placeholder Title</h3>
                </Skeleton>
            </CardHeader>
            <CardBody className='px-3 pb-2'>
                <Skeleton className='h-4 mb-1 rounded-lg overflow-clip'>
                    <div className='font-mono text-default-400'>Tag1 · Tag2 · Tag3</div>
                </Skeleton>
                <Skeleton className='h-4 rounded-lg overflow-clip'>
