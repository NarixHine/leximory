                ...
                <Card className='p-4'>
                    <CardBody className='gap-4'>
                        <div className='flex flex-col gap-2'>
                            <H fancy disableCenter className='text-2xl'>
                                Beginner 初学者
                            </H>
                        ...
                        <div className='flex flex-col gap-3'>
                            <div className='flex items-start gap-2'>
                                ...
                                <div className='flex flex-col'>
                                    ...
                                    <span className='text-default-500 text-sm'>
                                        相当于 {PLAN_COMMENTARY_QUOTA.beginner * 4} 次词汇注解
                                    </span>
                                </div>
                            </div>
                            <div className='flex items-start gap-2'>
                            ...
                            <div className='flex items-start gap-2'>
                                ...
                                <div className='flex flex-col'>
                                    ...
                                    <span className='text-default-500 text-sm'>
                                        可领取 {PLAN_DAILY_LEXICOIN.beginner} 个代币
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col gap-3'>
                            ...
                            <div className='flex items-start gap-2'>
                                ...
                                <div className='flex flex-col'>
                                    ...
                                    <span className='text-default-500 text-sm'>
                                        相当于 {PLAN_COMMENTARY_QUOTA.bilingual * 4} 次词汇注解
                                    </span>
                                </div>
                            </div>
                            <div className='flex items-start gap-2'>
                            ...
                            <div className='flex items-start gap-2'>
                                ...
                                <div className='flex flex-col'>
                                    <span>每日 LexiCoin</span>
                                    <span className='text-default-500 text-sm'>
                                        可领取 {PLAN_DAILY_LEXICOIN.bilingual} 个代币
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <CardBody className='gap-4 flex flex-col'>
                        <div className='flex flex-col gap-2'>
                            <div className='flex items-center gap-1 justify-between'>
                                ...
                                <span
                                    className={cn(
                                        'text-primary-500 text-xs bg-primary-50 px-2 py-1 rounded-full',
                                    )}
                                >
                                    推荐
                                </span>
                        ...
                        <div className='flex flex-col gap-3'>
                            ...
                            <div className='flex items-start gap-2'>
                                ...
                                <div className='flex flex-col'>
                                    ...
                                    <span className='text-default-500 text-sm'>
                                        相当于 {PLAN_COMMENTARY_QUOTA.polyglot * 4} 次词汇注解
                                    </span>
                                </div>
                            </div>
                            <div className='flex items-start gap-2'>
                            ...
                            <div className='flex items-start gap-2'>
                                ...
                                <div className='flex flex-col'>
                                    <span>每日 LexiCoin</span>
                                    <span className='text-default-500 text-sm'>
                                        可领取 {PLAN_DAILY_LEXICOIN.polyglot} 个代币
                                    </span>
                                </div>
                            </div>
                        </div>
