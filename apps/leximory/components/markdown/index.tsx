...
function Markdown({
    ...
    const firstParaDropcap =
        strategy.isDropcapEnabled &&
        (/^\p{L}/u.test(
            result
                .replace(/^<article>\n?/, '')
                .replace(/^[\u200B\u200E\u200F\u00A0]+/, '')
