        ...
        <section className='min-h-[85dvh] flex flex-col justify-center px-6 pt-[30vh] pb-12'>
            <div className='max-w-5xl w-full mx-auto'>
                <div className='flex items-center gap-4 animate-in fade-in slide-in-from-bottom-2 duration-500 mb-4'>
                    ...
                    <div
                        className='justify-between flex flex-col h-full gap-0.5 animate-blur-in'
                        style={{ animationDelay: '80ms' }}
                    >
                        <h1 className='text-4xl sm:text-5xl font-fancy tracking-tight text-default-800'>
                            <span>Leximory</span>{' '}
                            <span className='text-xl sm:text-[1.72rem] font-bold'>猫忆</span>
                        </h1>
                        <p className='text-xl text-default-500 font-kaiti'>语言学地学语言</p>
                    </div>
                </div>
                ...
                >
                    <span className='font-fancy text-xl text-primary-800 font-normal [font-variant-caps:small-caps]'>
                        Leximory
                    </span>{' '}
                    是一个搭载
                    <span className='font-fancy text-xl italic bg-linear-to-r from-pink-300 to-sky-400 bg-clip-text text-transparent'>
                        {' '}
                        AI{' '}
                    </span>
                    的语言学习平台，旨在通过整合
                ...
                <div
                    className='flex gap-3 mb-20 animate-in fade-in slide-in-from-bottom-2 duration-500 fill-mode-both'
                    style={{ animationDelay: '300ms' }}
                >
                    <LinkButton
                        startContent={<PiShootingStarDuotone className='text-xl' />}
                        radius='full'
                        color='primary'
                        href={SIGN_IN_URL}
                        size='lg'
                ...
                <div
                    className='w-full animate-in fade-in slide-in-from-bottom-2 duration-500 fill-mode-both'
