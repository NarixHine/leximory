        ...
        <Center>
            <div className='flex flex-col items-center justify-center sm:flex-row my-3'>
                <Link href={'/'} className='border-l-2 border-l-primary-800/50 px-3 py-1'>
                    <H
                        disableCenter
                        className={'text-primary-800 text-4xl pb-2 font-semibold'}
                        fancy
                    >
                        <span className='opacity-30'>The</span>{' '}
                        <span className='mx-1'>Leximory</span>{' '}
                ...
                <div className='space-y-3 flex flex-wrap justify-center'>
                    {postsData.map((post, i) => (
                        <span key={i} className='border-primary/10 px-3 not-prose inline-block'>
                            ...
                            <H
                                disableCenter
                                className={'text-sm -my-0.5 text-default-400 font-mono!'}
                            >
