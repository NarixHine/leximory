...
export const ConfirmStory = createCallable<{ comments: string[] }, Response>(
    ({ call, comments }) => (
        <Card
            role='dialog'
            className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 p-6 max-w-md shadow-lg'
        >
            <CardHeader>
            ...
            <CardFooter className='flex gap-2 justify-end'>
                <Button variant='light' color='default' onPress={() => call.end(false)}>
                    取消
                </Button>
                <Button
                    variant='flat'
