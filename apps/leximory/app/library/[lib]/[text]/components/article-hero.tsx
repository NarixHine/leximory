...
export function ArticleHero({
    ...
    return (
        <>
            <div
                className={cn(
                    'print:hidden hidden md:flex md:flex-col w-full opacity-100 transition-opacity duration-500',
                ...
                <div className='grid grid-cols-[1fr_1fr] gap-12 min-h-screen items-center'>
                    <div className='flex flex-col max-w-[calc(40dvw)] mx-auto self-end pb-11'>
                        ...
                        <TagPills
                            ...
                            classNames={{ content: 'px-0', base: 'border-0' }}
                        />
                    </div>
            ...
            <div
                className={cn(
                    'print:hidden md:hidden w-full mb-8 transition-opacity duration-2000',
                    isFullViewport && 'invisible',
                )}
            >
                ...
                <div className='flex justify-center my-3'>
                    <TagPills
                        ...
                        size='md'
                        color='secondary'
                        className='text-sm text-secondary-400 border-1 border-secondary-300'
                        classNames={{ content: 'px-1.25' }}
                    />
                </div>
            </div>
        </>
