        ...
        <SectionCard
            ...
            footer={
                <Button
                    ...
                    color='default'
                    isLoading={isLoading}
                    startContent={<PiEnvelopeSimple size={20} />}
                >
                    {isLoading ? '更新中...' : '更新邮箱'}
                </Button>
            }
...
function PasswordSection({ onSuccess }: { onSuccess?: () => void }) {
    ...
    return (
        ...
        >
            ...
            <div className='my-4'>
                <label htmlFor='confirm-password' className='font-medium text-sm leading-none'>
                    确认密码
                </label>
                <Input
                    id='confirm-password'
    ...
    return (
        <SectionCard title='登出'>
            <Button
                ...
                variant='flat'
                isLoading={isLoading}
                startContent={<PiSignOut size={20} />}
            >
                退出登录
            </Button>
        </SectionCard>
...
export default function UpdateProfile({
    ...
    className,
    ...props
}: React.ComponentPropsWithoutRef<'div'> & { userId: string; username?: string; image?: string }) {
    return (
        <div
            className={cn(
                'justify-center items-center gap-3 grid grid-cols-1 md:grid-cols-2 bg-background w-full min-h-[60vh]',
                className,
            )}
            {...props}
        >
