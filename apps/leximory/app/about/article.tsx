...
export function Article() {
    return (
        <article className='text-xl font-formal'>
            <motion.p
            ...
            >
                Leximory 是一个
                <span className='bg-default-200 px-1 rounded-md box-decoration-clone leading-[1.8]'>
                    以大量阅读为宗
                </span>
                的语言学习平台。
            </motion.p>
            ...
            >
                科学研究表明，只有通过大量的阅读，才能
                <span className='bg-primary-50 px-1 rounded-md box-decoration-clone leading-[1.8]'>
                    真正习得词汇与文法
                </span>
                。
            </motion.p>
            ...
            >
                Leximory 为阅读提供必要辅助：
                <span className='bg-secondary-100 px-1 rounded-md box-decoration-clone leading-[1.8]'>
                    智能注解
                </span>
                、
                <span className='bg-secondary-100 px-1 rounded-md box-decoration-clone leading-[1.8]'>
                    ...
                    <GradientCard
                        title={
                            <span className='font-mono'>
                                <img
                                    src='/images/eck.ico'
                                    className='size-8 inline-block mr-2 align-top'
                                    alt='Exam Char Key'
                                />
                                Exam Char Key
                            </span>
            ...
            <iframe
                className='rounded-xl my-4 md:h-90 sm:h-80 h-70'
...
const GradientCard = ({
    ...
    return (
        <Card
            ...
            shadow='none'
            className={cn('p-3 min-h-36 h-full w-full relative rounded-lg', className)}
        >
