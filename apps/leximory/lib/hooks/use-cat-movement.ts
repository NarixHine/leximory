...
export function getVelocityAtProgress(progress: number, maxSpeed: number, accelEnd: number, decelStart: number): number {
...
export function useCatMovement({
    ...
    return useMemo(() => ({
        ...
        cancelMovement,
        setInitialPosition,
    }), [catState.isRunning, catState.facingLeft, particles, positionRef, phaseRef, isAnimatingRef, moveToPosition, cancelMovement, setInitialPosition])
}
