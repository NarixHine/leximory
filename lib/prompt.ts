...
export const instruction: {
  ...
  **禁止把屈折变化的后缀放入语源，例如-ed、-ing、-en、-e。**
  ...
  示例文本四：
  It felt surreal to be told I had an incurable blood cancer, one that I would later find out had ultimately felled my hero, the comedian Norm Macdonald. The scene from the film “50/50” came to mind where, upon being told he had cancer, a young man responds incredulously, “That doesn’t make any sense, though. I don’t smoke. I don’t drink. I recycle.” I was obsessed with the idea that I was going to die.
