...
- Extra items: 1pt each, but ONLY if ALL essential items are fulfilled (deducted entirely otherwise).
...
前提：你必须尊重原文的内容、文风（和英语变体）！对失当措辞作改动（包含首尾），但保持实质性内容不变。用粗体标记所有改动部分。
